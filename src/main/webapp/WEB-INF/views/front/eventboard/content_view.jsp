...
<body>
   ...
   <div id="wrap" class="table">  
      <table width="100%"  class="nb">
         <form action="EB_modify_view" method="post">
         ...
         <thead >
           <tr class="thead-inverse"> 
            ...
            <tr>
               <td>${content_view.e_title}</td>
               <td>${content_view.e_writer}</td>
               <td>${fname}</td>
            </tr>
            <tr>
               <td colspan="3">
                  ${content_view.e_contents}
               </td>
            </tr>
            
            <tr>
               <td colspan="3"> 
                  <input type="button" value="목록보기" onclick="location.href='EB_list'">
                  <!-- <a href="list">목록보기</a> -->
               </td>
            </tr>
         </form>
      ...
      <form action="EB_content_view_comment" method="post">
		<div class="CenterGo" >
				 ...
				 <c:forEach var="ListComment" items="${ListComment}"> 
					<tr align="center">
						...
						<%-- 	<c:if test="${m_id==guestBook.my_id}"> --%>
									<input onclick="location.href='ECM_delete?e_no=${content_view.e_no}&comment_seq=${ListComment.comment_seq}'" type="button" value="삭제" >
							<%-- </c:if> --%>
