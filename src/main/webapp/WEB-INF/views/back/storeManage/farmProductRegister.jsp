...
<body>
   <div id="product_register_content">
      ...
      <div id="content" class="form">
         ...
         <form action="farmProduct_write" method="post" enctype="multipart/form-data">
            ...
            <fieldset class="fieldSet_value">
               ...
               <input type="text" id="farm_name" title="상품명" maxlength="100" size="100" class="form-control"  name="s_title" required="required"> 
               <strong class="nameRealLength" >/100</strong>
               
               <h4 class=""><label>상품번호</label></h4>
               <input type="text" name="s_no" id="farm_no" title="상품번호" maxlength="100" size="100" required="required">
               
               <h4 class=""><label>상품가격</label></h4>
               <input type="text" name="s_price" id="farm_price" title="상품가격" maxlength="100" size="100" required="required">
