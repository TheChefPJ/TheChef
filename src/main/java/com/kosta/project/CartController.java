...
public class CartController {
	...
	//////////////레시피 상품 상세 페이지에서 장바구니에 추가했을 때///////////////////
	
	@RequestMapping("/recipe_cart")
	public String recipe_cart(HttpServletRequest request, Model model, Principal principal) throws Exception {
		request.setCharacterEncoding("utf-8");
		System.out.println("recipe_cart()");
		Timestamp reg_date = new Timestamp(System.currentTimeMillis());// reg_date
		int f_total_price;
		...
		int f_total_count = Integer.parseInt(request.getParameter("quantity"));
