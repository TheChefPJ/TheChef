                     ...
                     <td class="col-sm-4 col-md-2"> <!-- 상품 이미지 -->
                        <div class="media">
                           <c:if test="${list.category2==1}">
                           		<img alt="레시피/테마" src="upload/RTP/${list.p_thumbFile}"  width="200" height="150">
                           </c:if>
                           <c:if test="${list.category2==2}">
                           		<img alt="상품 골라담기" src="upload/farmProduct/${list.p_thumbFile}" width="200" height="150"/>
                           </c:if>
                        </div>
                     </td>
